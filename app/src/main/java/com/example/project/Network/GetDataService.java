...
public interface GetDataService {
    ...
    Call<ArrayList<Dosen>> getDosenAll(@Path("nim_progmob") String nim_progmob); //replace String {nim_progmob} dengan parameter yag dikirim pd baris ni
    //Call<List<Dosen>> getDosenAll(@Query("nim_progmob") String nim_progmob);
    //dua cara diatas sama, cmn klo pake php nativ pakai yang query klo yang laravel pake path
    // path --> api/progmob/dosen/721600012
    // query --> api/progmob/dosen?nim_progmob=721600012
